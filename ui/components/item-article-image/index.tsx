 ...
 */
export function ItemArticleImage({ imageUrl, id = '1' }: { imageUrl?: string | null; id: string }) {
  const colorToUse = getColorFromId(id)
  const { width, height } = { width: 640, height: 360 }
  return (
    <div className={style.base} data-color={colorToUse} data-testid="item-article-image">
