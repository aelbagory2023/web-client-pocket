...
export const HomeFlyawaySaveAlt = () => {
  ...
  const showFlyaway = flyawayReady && modalFinished

  useEffect(() => {
    let timer
    let element
    const highlightElement = () => {
      element = document.querySelectorAll(homeSaveQuery)[1]
  ...
  const description = t(
    'onboarding:flyaway-save-description',
