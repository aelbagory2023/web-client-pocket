...
export const MyListFlyawayExtensions = () => {
  ...
  const myListFlyawayDismissed = useSelector((state) => state.onboarding.myListFlyawayReader) === false
  ...
  const handleFirefox = () => dispatch(sendSnowplowEvent('onboarding.flyaway.extension.firefox.open'))
  const handleEdge = () => dispatch(sendSnowplowEvent('onboarding.flyaway.extension.edge.open'))
  const handleApple = () => dispatch(sendSnowplowEvent('onboarding.flyaway.extension.apple-badge.open'))
  const handleGoogle = () => dispatch(sendSnowplowEvent('onboarding.flyaway.extension.google-play-badge.open'))
