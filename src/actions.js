...
export const EXPLORE_DATA_FAILURE = 'EXPLORE_DATA_FAILURE'
export const EXPLORE_HYDRATE = 'EXPLORE_HYDRATE'
export const EXPLORE_SAVE_REQUEST = 'EXPLORE_SAVE_REQUEST'
export const EXPLORE_UNSAVE_REQUEST = 'EXPLORE_UNSAVE_REQUEST'
